...
with st.form("my_form"):
   ...
   age=st.slider("Select the student's age", min_value=None, max_value=None, value=None, step=None, format=None, key=None, help=None, on_change=None, args=None, kwargs=None, disabled=False, label_visibility="visible", width="stretch", bind=None)
